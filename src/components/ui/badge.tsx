...
const badgeVariants = cva(
  ...
  "group/badge inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-cb-chip border border-transparent px-2.5 py-1 font-cb-mono text-cb-foot font-medium whitespace-nowrap transition-all [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
