...
const buttonVariants = cva(
  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-cb-button border border-transparent bg-clip-padding font-cb-sans text-[15px] font-bold whitespace-nowrap transition-all duration-150 outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/40 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        xs: "h-8 gap-1 rounded-cb-chip px-2.5 text-[13px]",
        sm: "h-11 gap-1 px-3.5 text-[14px]",
        lg: "h-13 gap-1.5 rounded-cb-card px-5 text-[17px]",
        block: "h-14 w-full gap-2 rounded-cb-card px-5 text-[17px]",
        icon: "size-8",
